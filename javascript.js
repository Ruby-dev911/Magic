...
if (computerAnswer === 1) {
    ...
    console.log('You will succeed. It is inevitable.');
} else if (computerAnswer === 7) {
    console.log('If the ancient one wills it so..');
} else if (computerAnswer === 8) {
    console.log('Happiness is coming for you. Wether you like it or not.');
